...
resource "aws_s3_bucket" "foo_lb_logs" { # CorsConfiguration.CorsRules.AllowedMethods is not configured in file satwik-SE-satwik-SE.github.io/elb/utils.tf on line: 2
...
resource "aws_s3_bucket_policy" "foo_lb_logs" { # CorsConfiguration.CorsRules.AllowedMethods is not configured in file satwik-SE-satwik-SE.github.io/elb/utils.tf on line: 11
